...
class courseClass:
    def __init__(self, root):
        ...
        self.txt_courseName.place(x=180, y=60, width=500)
        txt_duration = Entry(self.root, textvariable=self.var_duration, font=("goudy old style", 20, "bold"), bg='lightyellow')
        txt_duration.place(x=180, y=100, width=500)
        txt_charges = Entry(self.root, textvariable=self.var_charges, font=("goudy old style", 20, "bold"), bg='lightyellow')
        txt_charges.place(x=180, y=140, width=500)
        self.txt_description = Text(self.root, font=("goudy old style", 20, "bold"), bg='lightyellow')
        self.txt_description.place(x=180, y=180, width=500, height=160)
        ...
        lbl_search_courseName.place(x=700, y=60)
...
# ===================================================================================
    ...
    def get_data(self,ev):
        ...
        # self.course.var_course.set(row[1])
        self.txt_description.delete('1.0',END)
